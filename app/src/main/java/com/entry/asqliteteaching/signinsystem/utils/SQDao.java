package com.entry.asqliteteaching.signinsystem.utils;
...
import com.entry.asqliteteaching.TeachDBHelper;
...
public class SQDao {
     ...
     *
     */
    public void updataDatabase(int oldVersion, int newVersion){
        sqLiteHelper.onUpgrade(sqLiteHelper.getWritableDatabase(), 3, 4);
    }
     ...
     * @return
     */
    public boolean insertAllArticless(List<Artical> lists){
        boolean flag = true;
    ...
    public boolean insertArticle(Artical artical){
        ...
        try {
            ...
            values.put("Age", 0);
            database.insertOrThrow(TeachDBHelper.TABLE_USER, null, values);
    ...
    public boolean refleshTable(@Table String table){
